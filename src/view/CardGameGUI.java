...
/**
 * This class provides a GUI for solitaire games related to Tens.
 */
public class CardGameGUI extends JFrame implements ActionListener {
	 ...
	 */
	public CardGameGUI(mod.Board board2) {
		board = board2;
		totalWins = 0;
		totalGames = 0;
	...
	private void initDisplay()	{
		...
		lossMsg.setText("Try again next time buddy :(");
		panel.add(lossMsg);
	...
	private String imageFileName(Card c, boolean isSelected) {
		String str = ".settings/cards/";
		if (c == null) {
			return ".settings/cards/back1.GIF";
		}
		str += c.rank() + c.suit();
		if (isSelected) {
			str += "S";
